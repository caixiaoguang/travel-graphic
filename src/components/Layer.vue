...
export default {
  ...
  methods: {
    onTilesetReady(tileset, viewer) {
      ...
      this.longitude = this.originLon = Cesium.Math.toDegrees(cartographic.longitude)
      this.latitude = this.originLat = Cesium.Math.toDegrees(cartographic.latitude)
      this.height = 0
    ...
    positionModify() {
      ...
      const offset = Cesium.Cartesian3.fromDegrees(this.longitude, this.latitude, this.height - 1135)
      const translation = Cesium.Cartesian3.subtract(offset, surface, new Cesium.Cartesian3())

      this.tileset.modelMatrix = Cesium.Matrix4.fromTranslation(translation)

      const destination = new mars3d.LatLngPoint(this.longitude, this.latitude, 100)
