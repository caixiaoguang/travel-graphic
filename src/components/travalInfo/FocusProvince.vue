<template>
  <div class="analysis-panel focus-province" v-show="active">
    <div class="title">
      <el-icon>
        <MapLocation />
      </el-icon>
      ...
      <el-tab-pane v-for="tab in tabList" :key="tab.name" :name="tab.name" :label="tab.label">
        <div class="content">
          <div class="cell" v-for="item in tab.data" :key="item">
            ...
            <div class="count">
              已开发：
              <span class="green">{{ item['已开发'] }}</span>
              个
            </div>
            <div class="count">
              等级开发比例：
              <span class="normal">{{ formatNumber(item['等级开发比例']) }}</span>
            </div>
            <div class="count">
              开发资源占比：
              <span class="normal">{{ formatNumber(item['开发资源占比']) }}</span>
            </div>
          </div>
        </div>
      </el-tab-pane>
